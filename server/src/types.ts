...
export type WorkflowGenerationSource = "api" | "mock" | "fallback";
...
export type WorkflowStep = {
  ...
  content: string;
  source: WorkflowGenerationSource;
  model: string;
  error?: string;
};
...
export type StoredWorkflowRecord = {
...
export type WorkflowRunHooks = {
  onEvent?: (event: WorkflowStreamEvent) => void | Promise<void>;
};
